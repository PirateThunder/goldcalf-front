...
export default function AllNotify() {
    ...
    const [saveText, setSaveText]: any = useState("Уведомить");
    ...
    const handleSave = () => {
        setSaveText('Уведомляем...')
        console.log(birth)
        // DATE.dmy_to_iso(birth)
        API.me_scream(localStorage.getItem('token'), desc)

        setSaveText('Уведомили!')
    }
